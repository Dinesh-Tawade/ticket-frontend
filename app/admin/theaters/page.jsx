...
//   FaCheckCircle, FaTimesCircle, FaTimes, FaStar
// } from 'react-icons/fa';
...
//         {/* Header */}
//         <div className="sticky top-0 bg-white dark:bg-gray-800 p-5 border-b border-gray-200 dark:border-gray-700 rounded-t-2xl">
//           <div className="flex justify-between items-start">
//             <div>
//               <h2 className="text-2xl font-bold">{theater?.name}</h2>
//               <p className="text-sm mt-1">{theater?.location}, {theater?.city}</p>
//             </div>
...
//                       ? 'bg-gray-900 dark:bg-gray-600 shadow-md'
...
//         <div className="p-6">
//           {/* Screen Info */}
//           <div className="flex justify-between items-center mb-6 p-5 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-800/30 rounded-2xl border border-gray-100 dark:border-gray-700">
//             <div>
//               <p className="text-sm text-gray-500 dark:text-gray-400">Screen {currentScreen.screenNumber}</p>
//               <p className="text-xl font-bold mt-1">{currentScreen.name}</p>
//             </div>
//             <div className="text-right">
//               <p className="text-sm text-gray-500 dark:text-gray-400">Total Seats</p>
//               <p className="text-3xl font-bold text-blue">{totalSeats}</p>
//             </div>
//           </div>

//           {/* Screen Display */}
//           <div className="relative mb-12">
//             <div className="w-full h-2 bg-gradient-to-r from-gray-300 to-gray-500 dark:from-gray-600 dark:to-gray-400 rounded-full" />
//             <div className="absolute -top-6 left-1/2 transform -translate-x-1/2  text-xs px-5 py-1.5 rounded-full font-medium tracking-wider shadow-lg">
//               SCREEN
//             </div>
//           </div>
...
//                 <div key={rowName} className="flex items-center gap-4 mb-3">
//                   <div className="w-10 text-center font-bold text-lg text-gray-600 dark:text-gray-400">{rowName}</div>
...
//                         className={`
//                           w-9 h-9 md:w-11 md:h-11 rounded-xl text-xs font-bold transition-all 
...
//             <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Seat Categories</p>
//             <div className="flex flex-wrap gap-5">
//               {[
//                 { cat: 'NORMAL', color: 'bg-green-500', price: 'Base Price', multiplier: '1x' },
//                 { cat: 'EXECUTIVE', color: 'bg-blue-500', price: 'Premium', multiplier: '1.5x' },
//                 { cat: 'PREMIUM', color: 'bg-purple-500', price: 'Luxury', multiplier: '2x' },
//                 { cat: 'VIP', color: 'bg-yellow-500', price: 'Royal', multiplier: '3x' }
//               ].map(cat => (
//                 <div key={cat.cat} className="flex items-center gap-3">
//                   <div className={`w-6 h-6 rounded-lg ${cat.color} shadow-sm`} />
//                   <div>
//                     <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{cat.cat}</span>
//                     <p className="text-xs text-gray-500 dark:text-gray-400">{cat.price}</p>
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//           {/* Hover Info */}
//           {hoveredSeat && (
//             <div className="mt-5 p-4 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 animate-in fade-in slide-in-from-bottom-2">
//               <p className="text-sm font-semibold text-gray-900 dark:text-white">
//                 Seat {hoveredSeat.row}{hoveredSeat.number}
//               </p>
//               <div className="flex gap-3 mt-1">
//                 <span className="text-xs text-gray-600 dark:text-gray-400">Category: {hoveredSeat.category}</span>
//                 <span className="text-xs text-gray-600 dark:text-gray-400">Multiplier: {hoveredSeat.multiplier}x</span>
//               </div>
//             </div>
//           )}
//         </div>
...
//         {/* Footer */}
//         <div className="sticky bottom-0 bg-white dark:bg-gray-800 p-4 border-t border-gray-200 dark:border-gray-700 rounded-b-2xl">
//           <button
//             onClick={onClose}
//             className="w-full bg-gray-900 hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 text-white py-3 rounded-xl font-semibold transition-all"
//           >
//             Close
//           </button>
//         </div>
...
//   return (
//     <div className="card group overflow-hidden hover:transform hover:-translate-y-2 transition-all duration-300">
//       {/* Card Header with Gradient */}
//       <div className="relative h-40 bg-gradient-to-r from-blue-800 to-blue-900">
//         <div className="absolute inset-0 transition-all" />
//         <div className="absolute inset-0 flex items-center justify-center">
//           <FaBuilding className="text-6xl text-white/20 group-hover:text-white/30 transition-all" />
//         </div>
...
//           className="absolute bottom-3 right-3 bg-white/10 hover:bg-white/20 backdrop-blur rounded-full p-2 transition-all"
//           title={theater.status === 'ACTIVE' ? 'Deactivate' : 'Activate'}
//         >
//           {theater.status === 'ACTIVE' ? (
//             <FaTimesCircle className="text-yellow text-sm" />
//           ) : (
//             <FaCheckCircle className="text-green text-sm" />
//           )}
//         </button>
//       </div>
...
//             {theater.name}
//           </h3>
//           <div className="flex items-center gap-1 text-gray-500 dark:text-gray-400 text-sm mt-1.5">
//             <MdLocationOn className="text-blue" />
...
//             <MdTheaters className="text-xl mx-auto text-blue" />
//             <p className="text-xl font-bold text-gray-900 dark:text-white">{totalScreens}</p>
//             <p className="text-xs text-gray-500 dark:text-gray-400">Screens</p>
//           </div>
//           <div className="text-center">
//             <FaTicketAlt className="text-xl mx-auto text-green" />
...
//           </div>
//           <div className="text-center">
//             <FaPhone className="text-xl mx-auto text-purple" />
//             <p className="text-sm font-bold text-gray-900 dark:text-white mt-0.5">{theater.contactNumber}</p>
...
//             <div key={name} className="flex items-center gap-1.5 bg-gray-100 dark:bg-gray-800 px-3 py-1.5 rounded-full text-xs">
//               <Icon className="text-gray-500 dark:text-gray-400 text-xs" />
//               <span className="text-gray-700 dark:text-gray-300">{name}</span>
//             </div>
//           ))}
//           {!AMENITIES.some(a => theater[a.key]) && (
//             <span className="text-xs text-gray-400 italic">No amenities available</span>
//           )}
//         </div>
...
//             className="flex-1 bg-red py-2.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition-all"
//           >
//             <FaEye className="text-sm" /> View Layout
//           </button>
//           <button
//             onClick={() => onEdit(theater)}
//             className="bg-blue hover:bg-blue text-white p-2.5 rounded-xl transition-all"
//           >
//             <FaEdit />
//           </button>
//           <button
//             onClick={() => onDelete(theater)}
//             className="bg-gray-900 hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 text-white p-2.5 rounded-xl transition-all"
//           >
//             <FaTrash />
//           </button>
//         </div>
...
//           <FaTrash className="text-red text-2xl" />
//         </div>
//         <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Delete Theater</h2>
//         <p className="text-gray-600 dark:text-gray-400 mb-6">
//           Are you sure you want to delete <strong className="text-gray-900 dark:text-white">{theaterName}</strong>?
//         </p>
//         <div className="flex gap-3">
//           <button
//             onClick={onConfirm}
//             className="flex-1 bg-red hover:bg-red text-white py-2.5 rounded-xl font-semibold transition-all"
//           >
//             Yes, Delete
//           </button>
//           <button
//             onClick={onClose}
//             className="flex-1 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white py-2.5 rounded-xl font-semibold transition-all"
//           >
//             Cancel
//           </button>
//         </div>
...
//           ) : (
//             <FaTimesCircle className="text-yellow text-2xl" />
//           )}
//         </div>
...
//         </h2>
//         <p className="text-gray-600 dark:text-gray-400 mb-6">
//           Are you sure you want to {action} <strong className="text-gray-900 dark:text-white">{theater?.name}</strong>?
//         </p>
//         <div className="flex gap-3">
//           <button
//             onClick={onConfirm}
...
// const StatsCard = ({ label, value, icon: Icon, bgClass }) => (
//   <div className={`${bgClass} rounded-2xl p-5 text-white shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1`}>
...
//         <div className="text-center">
//           <div className="animate-spin rounded-full h-14 w-14 border-b-2 border-gray-900 dark:border-gray-400 mx-auto"></div>
//           <p className="mt-4 text-gray-600 dark:text-gray-400 font-medium">Loading theaters...</p>
//         </div>
//       </div>
//     );
//   }
...
//             <FaTimesCircle className="text-red text-3xl" />
//           </div>
//           <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Failed to load theaters</h2>
//           <p className="text-gray-600 dark:text-gray-400 mb-6">{error.message}</p>
//           <button
//             onClick={() => refetch()}
//             className="bg-gray-900 hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 text-white px-6 py-2.5 rounded-xl font-medium transition-all"
//           >
//             Retry
//           </button>
//         </div>
...
//       {/* Header */}
//       <div className=" border-b border-gray-200 dark:border-gray-800 sticky top-0 z-20 shadow-sm">
//         <div className="container mx-auto px-4 py-5">
//           <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
//             <div>
//               <h1 className="text-3xl md:text-4xl font-bold flex items-center gap-3">
//                 <FaBuilding className="text-blue" />
//                 Theater Management
//               </h1>
//               <p className="text-gray-500 dark:text-gray-400 mt-1">Manage all theaters, screens, and seat layouts</p>
//             </div>
//             <button
//               onClick={() => router.push('/admin/theaters/add')}
//               className=" hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2 shadow-md transition-all transform hover:scale-105"
//             >
//               <FaPlus className="text-sm" /> Add New Theater
//             </button>
//           </div>
//         </div>
//       </div>
...
//           <StatsCard label="Total Theaters" value={stats.total} icon={FaBuilding} bgClass="bg-blue" />
//           <StatsCard label="Active" value={stats.active} icon={FaCheckCircle} bgClass="bg-green" />
//           <StatsCard label="Inactive" value={stats.inactive} icon={FaTimesCircle} bgClass="bg-gray-500" />
//           <StatsCard label="Total Screens" value={stats.screens} icon={MdTheaters} bgClass="bg-purple" />
//           <StatsCard label="Cities" value={stats.cities} icon={FaMapMarkerAlt} bgClass="bg-yellow" />
//         </div>
...
//                 className="w-full pl-11 pr-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl  text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all"
//               />
//             </div>
//             <select
//               value={statusFilter}
//               onChange={(e) => setStatusFilter(e.target.value)}
//               className="px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-gray-400 transition-all"
//             >
...
//                   setCityFilter('ALL');
//                 }}
//                 className="px-5 py-3 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-medium transition-all"
//               >
//                 Clear Filters
//               </button>
//             )}
...
//             <div className="w-28 h-28 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-5">
//               <FaBuilding className="text-gray-400 text-5xl" />
//             </div>
//             <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">No theaters found</h3>
...
//               <button
//                 onClick={() => router.push('/admin/theaters/add')}
//                 className="bg-gray-900 hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-700  px-6 py-3 rounded-xl font-semibold inline-flex items-center gap-2 transition-all"
//               >
